# Getting help with stf

Thanks for using stf. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/stf/issues) to make sure the 
