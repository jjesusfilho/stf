...
Para baixar acórdãos e decisões monocráticas com termos de busca, use a função `stf_download_cjsg`. Se, por exemplo, você quiser baixar decisões com os termos "mulher, violência e gênero", proceda da seguinte forma:
...
```
Eu usei size = 20, mas você pode aumentar o número de decisões por arquivo para até 200.
