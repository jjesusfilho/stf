...
[![Coverage status](https://codecov.io/gh/jjesusfilho/stf/branch/master/graph/badge.svg)](https://codecov.io/github/jjesusfilho/stf?branch=master)
...
We have provided a dataset with annual rullings' collection from 2010 to 2019 in the package. Thus for these years, you don't need to download the spreadsheet, just load the data:
